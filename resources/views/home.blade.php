                                    ...
                                    <div class="tab-content p-0">
                                        ...
                                        <div class="container ml-10 mr-10">
                                            <div class="row ">
                                                ...
                                                <a class="share mx-auto" style="color:#3a5897 !important;"
                                                    href="mailto:geral@20mediar.pt?subject=https://www.facebook.com/sharer/sharer.php?u=<?php echo url('/register?').http_build_query(['invite' => Auth::user()->uuid ], null, '&', PHP_QUERY_RFC3986);?>">
